...
| --- | --- | --- | --- | --- |
| asr-45s | Transcribe ~45s of generated speech | 6.0 | 8.0x | — |
| extract-120s | Full extract of a 120s 720p video | 3.3 | 36.5x | ingest 0.0s · transcribe 1.4s · frames 1.9s · timeline 0.0s |
| frames-batch-5 | Batch export of 5 frames | 0.1 | — | — |

Machine: Apple M5 · 10 logical cores · macos/aarch64 · vts-extract 0.2.1
